 ...
 */
// @ts-expect-error - intentionally unused function, kept for future reference
function _getTimezoneOffset(timezone: string, date: Date): number {
  try {
    ...
    console.error(`[Timezone] Error getting offset for ${timezone}:`, error);
    return 0;
  }
}
