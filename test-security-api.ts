 ...
 *  npx tsx test-security-api.ts user1@email.com pass1 user2@email.com pass2 supabase-url supabase-key
 * 
...
// Usage: npx tsx test-security-api.ts user1@email.com pass1 user2@email.com pass2 [supabase-url] [supabase-key]
...
async function testSecurity() {
  ...
  if (!SUPABASE_URL || !SUPABASE_ANON_KEY) {
    ...
    console.error('   npx tsx test-security-api.ts');
    console.error('\n2. Command line arguments:');
    console.error('   npx tsx test-security-api.ts user1@email.com pass1 user2@email.com pass2 supabase-url supabase-key');
    process.exit(1);
  }
  ...
  try {
    ...
    if (deleteError) {
      ...
      // This is BAD - deletion succeeded
      logResult({
        name: 'Test 4: User 2 cannot delete User 1\'s task',
        passed: false,
